...
D_start=-60;  % spatial scope [-60 59] 
D_stop=59;  % spatial scope [-60 59]
LM=1000;  %sample number
theta=D_start:1:D_stop;  % spatial grid
L=length(theta);  % grid number
A=exp(1i*pi*fc*(0:M-1)'*sind(theta)/f0);  % array manifold
H=zeros(M*M,L);
...
save('C:\Users\Administrator\Desktop\DEEPDOA\code\data2train\data2_angle.mat','R_est','DOA_train','gamma_R',...
