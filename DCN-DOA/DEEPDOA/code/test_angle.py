...
autoencoder= keras.models.load_model(r"C:\Users\Administrator\Desktop\DEEPDOA\code\autoencoder.h5")
#
model_low_liu1= keras.models.load_model(r"C:\Users\Administrator\Desktop\DEEPDOA\code\model_low_liu1.h5")
model_low_liu2= keras.models.load_model(r"C:\Users\Administrator\Desktop\DEEPDOA\code\model_low_liu2.h5")
model_low_liu3= keras.models.load_model(r"C:\Users\Administrator\Desktop\DEEPDOA\code\model_low_liu3.h5")
model_low_liu4= keras.models.load_model(r"C:\Users\Administrator\Desktop\DEEPDOA\code\model_low_liu4.h5")
model_low_liu5= keras.models.load_model(r"C:\Users\Administrator\Desktop\DEEPDOA\code\model_low_liu5.h5")
model_low_liu6= keras.models.load_model(r"C:\Users\Administrator\Desktop\DEEPDOA\code\model_low_liu6.h5")
cnn_low= keras.models.load_model(r"C:\Users\Administrator\Desktop\DEEPDOA\code\cnn_low.h5")

#

#
read_temp=scipy.io.loadmat(r"C:\Users\Administrator\Desktop\DEEPDOA\code\data2angle\data2_angle.mat")
...
[r2,c,S]=np.shape(R_est)         #[1000,56,14]
[r2,I,S]=np.shape(S_label)       #[1000,120,14]
K=2
...
plt.semilogy(DOA_train[1,1,:]-DOA_train[0,1,:],RMSE_SBL_R-0.0*np.ones((S,1)))
plt.semilogy(DOA_train[1,1,:]-DOA_train[0,1,:],RMSE_SBL-0.0*np.ones((S,1)))
