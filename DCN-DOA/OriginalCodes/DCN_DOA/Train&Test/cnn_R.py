...
from tensorflow.keras.optimizers import RMSprop,Adam as rmsprop,Adam
...
I=120
t=int(np.floor(I/P))
autoencoder= keras.models.load_model( '/Users/mclinwong/GitHub/CodesReproduction/DCN-DOA/OriginalCodes/code/autoencoder.h5')
