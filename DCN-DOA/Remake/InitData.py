...
class LoadData():
    ...
    def read_data(self):
        read_data = scipy.io.loadmat(f'{self.matlib}data2_trainlow.mat')
    ...
    def read_spectrum(self):
        read_temp = scipy.io.loadmat(f'{self.matlib}data2_test.mat')
    ...
    def data_loader(self, S_abs, S_label, S_label1, batch_size):
        S_est_train, S_est_test, S_label1_train, S_label1_test = train_test_split(
            self, S_label1, test_size=0.2
        )
        S_abs_train, S_abs_test, S_label_train, S_label_test = train_test_split(
            S_abs, S_label, test_size=0.2
        )
